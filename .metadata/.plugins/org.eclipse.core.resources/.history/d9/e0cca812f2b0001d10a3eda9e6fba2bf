...
public class UsersConfig {
	...
	CommandLineRunner commandLineRunner( UsersRepository userRepo, PostRepository postRepo, LikesRepository likerepo,
		...
		return args -> {
			...
			Users user3 = new Users("Allan", "Dela Cruz", "pola", "09123456789", "allan@delacruz", "admin2255", "Pasig", "07/15/1999");
			Users user4 = new Users("Nick", "Dela Cruz", "pola", "09123456789", "nick@delacruz", "admin2255", "Cebu", "07/15/1999");
			Users user5 = new Users("Janus", "Dela Cruz", "pola", "09123456789", "janus@delacruz", "admin2255", "Mindanao", "07/15/1999");
			userRepo.saveAll(List.of(user1, user2, user3, user4, user5));
			
			Post p1 = new Post(1, user1, "Good Morning", "", "02/17/2023");
